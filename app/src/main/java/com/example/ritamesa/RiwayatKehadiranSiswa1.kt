...
class RiwayatKehadiranSiswa1 : AppCompatActivity() {
    ...
    inner class AttendanceAdapter1(private var list: List<Attendance1>) : RecyclerView.Adapter<AttendanceAdapter1.ViewHolder>() {
        inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
            val textNama: TextView = view.findViewById(R.id.textView58)
            val textKelas: TextView = view.findViewById(R.id.textView59)
            val textStatus: TextView = view.findViewById(R.id.textView60)
            val textKeterangan: TextView = view.findViewById(R.id.textView61)
        }
