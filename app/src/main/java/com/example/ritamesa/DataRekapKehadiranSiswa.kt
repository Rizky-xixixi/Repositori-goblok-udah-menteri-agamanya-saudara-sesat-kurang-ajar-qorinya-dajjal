...
class DataRekapkehadiranSiswa : AppCompatActivity() {
                ...
                if (response.isSuccessful) {
                    ...
                    if (attendanceItems.isEmpty()) {
                        ...
                        attendanceItems.forEach { item ->
                            ...
                            itemView.findViewById<TextView>(R.id.tvMapelKelas).text = item.schedule?.subjectInfo?.name ?: "-"
                            itemView.findViewById<TextView>(R.id.tvJam).text = item.checkInTime?.substringAfter(" ")?.substringBeforeLast(":") ?: "-" 
    ...
    inner class SiswaAdapterWaka(
        ...
        inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
            ...
            val tvKelas: TextView = view.findViewById(R.id.tvMataPelajaran)
        }
